...
export const generateStep1 = (): Step1Result => {
  ...
  if (roll >= 14 && roll <= 18) return { roll, type: 'Magic Warding Scroll', isSpellScroll: false, totalLevels: 0, isFinished: true, message: 'Generation Ends: A Magic Warding Scroll was generated. Please consult page 146 of the Judges Journal' };

  if (roll >= 80 && roll <= 84) return { roll, type: 'Treasure Map (Treasure Type B)', isSpellScroll: false, totalLevels: 0, isFinished: true, message: 'Generation Ends: A Treasure Map of the rolled type was generated. Please proceed to the Treasure Map Generator.'};
  if (roll >= 85 && roll <= 88) return { roll, type: 'Treasure Map (Treasure Type D)', isSpellScroll: false, totalLevels: 0, isFinished: true, message: 'Generation Ends: A Treasure Map of the rolled type was generated. Please proceed to the Treasure Map Generator.'};
  if (roll >= 89 && roll <= 91) return { roll, type: 'Treasure Map (Treasure Type H)', isSpellScroll: false, totalLevels: 0, isFinished: true, message: 'Generation Ends: A Treasure Map of the rolled type was generated. Please proceed to the Treasure Map Generator.'};
  if (roll >= 92 && roll <= 94) return { roll, type: 'Treasure Map (Treasure Type N)', isSpellScroll: false, totalLevels: 0, isFinished: true, message: 'Generation Ends: A Treasure Map of the rolled type was generated. Please proceed to the Treasure Map Generator.'};
  if (roll >= 95 && roll <= 97) return { roll, type: 'Treasure Map (Treasure Type Q)', isSpellScroll: false, totalLevels: 0, isFinished: true, message: 'Generation Ends: A Treasure Map of the rolled type was generated. Please proceed to the Treasure Map Generator.'};
  if (roll >= 98 && roll <= 100) return { roll, type: 'Treasure Map (Treasure Type R)', isSpellScroll: false, totalLevels: 0, isFinished: true, message: 'Generation Ends: A Treasure Map of the rolled type was generated. Please proceed to the Treasure Map Generator.'};
